                            ...
                            <div class="card card-danger">
                                ...
                                <table id="example1" class="table table-bordered table-striped table-sm">
                                    ...
                                    <div class="container-fluid" style="font-size: 12px">
                                        ...
                                        <form action="../../config/controladores/ventas/elimina_venta.php" enctype="multipart/form-data" method="post" autocomplete="off">
                                        <input type="hidden" name="idVenta" value="<?php echo $id; ?>">

                                        <div class="form-group">
                                            <a href="ventas.php" class="btn btn-secondary">Cancelar</a>
                                            <button type="submit"  value="Eliminar Venta" class="btn btn-danger">Eliminar Venta</button>
                                        </div>   
